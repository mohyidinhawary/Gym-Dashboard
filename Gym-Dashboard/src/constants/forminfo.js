export const inputFormElements=[
    ...
    {
        name:"address",placeholder:"Enter address", label:"address", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    },
    {
        name:"Gender",placeholder:"", label:"Gender", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    }, {
        name:"experince",placeholder:"Enter experince", label:"experince", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    }, {
        name:"contract type",placeholder:"", label:"contract type", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    }, {
        name:"salary",placeholder:"Enter salary", label:"salary", 
